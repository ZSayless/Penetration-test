    ...
    <section id="contact" className="relative py-24">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-3 gap-10">
          {/* Contact Information */}
          <div className="lg:col-span-1 space-y-8 bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-lg">
            <div>
          ...
          {/* Contact Form */}
          <div className="lg:col-span-2 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-8">
