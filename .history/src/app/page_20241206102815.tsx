      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 py-20 sm:py-24 md:py-28">
        ...
        <div className="relative w-full max-w-7xl mx-auto">
          <div className="text-center space-y-8 sm:space-y-12">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 max-w-3xl mx-auto px-4">
              <div className="p-3 sm:p-4 rounded-lg bg-white/10 backdrop-blur-sm hover:bg-white/15 transition-colors duration-300">
                <div className="text-2xl sm:text-3xl font-bold text-white">500+</div>
                <div className="text-xs sm:text-sm text-blue-200">Security Audits</div>
              </div>
